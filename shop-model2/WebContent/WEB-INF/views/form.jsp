...
<div class="container">
	...
	<c:if test="${not empty param.error and param.error eq 'pwd' }">
		<div class="row">
			<div class="col-12">
	...
	<c:if test="${not empty param.error and param.error eq 'dup' }">
		<div class="row">
			<div class="col-12">
				<div class="alert alert-danger">
	...
	<div class="row">
		<div class="col-12">
			<div class="card">
				<form id="user-form" method="post" action="register.hta" onsubmit="checkUserForm(event)">
