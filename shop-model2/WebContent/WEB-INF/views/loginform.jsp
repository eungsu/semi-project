...
<div class="container">
	...
	<c:if test="${not empty param.error and param.error eq 'empty' }">
		<div class="row">
	...
	<c:if test="${not empty param.error and param.error eq 'invalid' }">
		<div class="row">
			<div class="col-6 offset-3">
				<div class="alert alert-danger">
	...
	<c:if test="${not empty param.error and param.error eq 'deny' }">
		<div class="row">
			<div class="col-6 offset-3">
				<div class="alert alert-danger">
	...
	<div class="row">
		<div class="col-6 offset-3">
			<div class="card">
				<form id="login-form" method="post" action="login.hta" onsubmit="checkLoginForm(event)">
